  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        const Responsive(
          desktop:
              AnimatedSubtitleText(start: 30, end: 40, text: 'Web & Mobile '),
          largeMobile:
              AnimatedSubtitleText(start: 30, end: 25, text: 'Web & Mobile '),
          mobile:
              AnimatedSubtitleText(start: 25, end: 20, text: 'Web & Mobile '),
          tablet:
              AnimatedSubtitleText(start: 40, end: 30, text: 'Web & Mobile '),
        ),
